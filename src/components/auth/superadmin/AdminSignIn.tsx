        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Sign in to your account to manage restaurants and oversee operations.
            </p>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div className="pt-2">
                  <Button className="w-full py-3 text-base" size="lg" variant="newvariant" type="submit" disabled={isLoading}>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <Link
                      href="/admin/signup"
                      className="font-semibold text-orange-500 transition-colors hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-300 underline underline-offset-4"
                    >
