      ...
      <div className="mb-6 flex flex-col gap-3">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2 !rounded-full border-2 transition-all ${deliveryMethod === "delivery"
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2 !rounded-full border-2 transition-all ${deliveryMethod === "collection"
                ? "border-accent bg-accent/10 text-foreground"
                : "border-border bg-muted text-muted-foreground hover:border-accent/50"
              }`}
          >
      ...
      {items.length === 0 ? (
        ...
        <>
          ...
          <div className="space-y-3 border-t border-border pt-4">
            ...
            <button className="w-full !bg-[#DC5F00] text-accent-foreground font-bold py-3 !rounded-full hover:opacity-90 transition-opacity">
              Proceed to Checkout
            </button>
          </div>
        </>
